...
외국인이 한국에서 주식회사(株式會社)를 세우는 일은 겉으로는 간단해 보여도, **외국인투자촉진법에 따른 FDI 신고**, **자본금 송금 경로**, **법인 등기와 비자 연결**이 동시에 굴러가야 합니다.

셋 중 하나가 약하면 법인은 섰는데 외국인투자기업 등록이 안 되거나, 자본금은 들어왔는데 D-8 비자로 이어지지 않는 일이 실제로 벌어집니다.

핵심은 이것입니다.

1인 지분 100% 주식회사라도 **자본금 1억 원 이상 + 적법한 외국인투자신고**를 갖춰야 D-8 비자로 연결됩니다.

순서는 **외국인투자신고 → 자본금 송금(투자금 입금) → 법인 등기 → 사업자등록 → 외국인투자기업 등록 → 비자 신청/변경**입니다.
...
외국인이 실제로 선택하는 건 대부분 **주식회사** 아니면 **유한회사**입니다.
...
D-8 비자를 노린다면 **1인당 1억 원 이상 투자**가 사실상 기준선입니다.

법령상 "1억 이상"이 D-8의 명문 기준이며, 자본금이 1억이어도 **외국인 지분이 10% 미만**이거나, **외환 송금 증빙이 투자금으로 처리되지 않으면** FDI로 인정받지 못합니다.
...
| 단계 | 내용 | 처리처 | 소요기간 |
|---|---|---|---|
| 1 | 상호 중복 확인 + 정관 초안 | [대법원 인터넷등기소](https://www.iros.go.kr) | 1~2일 |
| 2 | 외국인투자신고(FDI) | [KOTRA](https://www.kotra.or.kr) / 외환은행·시중은행 | 당일~2일 |
| 3 | 자본금 송금 (투자금 입금) | 국내 은행 가상 자본금 계좌 | 2~5일 |
| 4 | 주식인수·주금납입보관증명서 수령 | 납입은행 | 1~2일 |
| 5 | 법인 설립등기 | 관할 [등기소](https://www.iros.go.kr) | 3~7일 |
| 6 | 사업자등록 | 관할 세무서 | 2~3일 |
| 7 | 외국인투자기업 등록 | [KOTRA](https://www.kotra.or.kr) / 외환은행 | 3~5일 |
| 8 | D-8 비자 신청/변경 | 출입국외국인청 | 2~4주 |

### 3-1. 외국인투자신고(FDI)를 먼저 해야 하는 이유

자본금 송금을 먼저 하고 나서 FDI를 내면, 은행은 그 송금을 **"투자금"이 아닌 일반 자본거래**로 처리해버립니다.

그러면 외국인투자기업 등록을 받을 때 자금 성격 증빙이 꼬입니다.

실무에서는 **FDI 신고 → 은행에서 "외국인투자자금" 꼬리표가 붙은 전용 계좌로 송금 → 주금납입증명**이 정석 루트입니다.
...
여권, 서명증명서, 송금 서류, 정관 모두에서 **외국인의 영문 성명이 완전히 동일**해야 합니다.
...
가상 오피스·공유오피스도 본점 소재지로 등기 자체는 가능하지만, **D-8 비자 심사 단계**에서 "실제 사업 공간인지"를 다시 따집니다.
...
실제 현금으로 나가는 돈은 **자본금 + 법정 세금 + 전문가 수수료**로 나뉩니다.
...
| 등기 수입증지 | 3만 원 내외 | [등기소](https://www.iros.go.kr) 납부 |
...
서울·인천·경기 일부는 **수도권 과밀억제권역**에 해당해 등록면허세가 3배로 올라갑니다.

같은 자본금 1억이라도 세종·지방 산단 vs 서울 본점이면 **등록면허세만 100만 원 넘게 차이**가 납니다.
...
자본금은 등기 완료 후 바로 회사 통장으로 풀려서, 임차료·급여·장비 구입 등 **정상적 사업 지출**에 자유롭게 쓸 수 있습니다.
...
- **[KOTRA](https://www.kotra.or.kr) 외국인투자지원센터(InvestKOREA)**: 온라인 신고 가능
...
주식회사는 현금 출자 외에 **현물출자**도 가능합니다.

기계설비, 특허권, 소프트웨어 라이선스 등이 해당됩니다.

다만 현물출자는 **법원 선임 검사인 또는 공인감정평가**가 필요해 시간·비용 모두 늘어납니다.
...
사업자등록이 나오면 영업일 기준 60일 이내에 **외국인투자기업 등록**을 신청해야 합니다.
...
**외국인투자기업 등록 완료 후 D-8 신청**이 가장 빠른 루트입니다.
...
서류가 본국에서 준비된 상태 기준, FDI 신고부터 사업자등록 완료까지 **평균 2~3주**, 외국인투자기업 등록 포함 **4주**, D-8 비자까지 포함하면 **6~10주**가 표준입니다.
...
문제는 **본국 송금 환원, 대표이사 개인 계좌 이체, 출처 불명 현금 인출**입니다.
