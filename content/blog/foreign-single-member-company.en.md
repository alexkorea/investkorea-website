...
<nav style="background:#f0f7ff;padding:20px;border-radius:8px;margin:24px 0">
  ...
  <ul style="list-style:none;padding-left:0">
    ...
    <li><a href="#section-3" style="color:#2563eb;text-decoration:none">3. Capital Requirements — KRW 100 Million vs. Below</a></li>
    <li><a href="#section-4" style="color:#2563eb;text-decoration:none">4. Can You Set Up a One-Person Corporation Without a Visa?</a></li>
    <li><a href="#section-5" style="color:#2563eb;text-decoration:none">5. Step-by-Step Incorporation Flow</a></li>
    <li><a href="#section-6" style="color:#2563eb;text-decoration:none">6. Required Documents and Home-Country Preparations</a></li>
    <li><a href="#section-7" style="color:#2563eb;text-decoration:none">7. Real-World Issues for the Sole Representative</a></li>
...
## <span id="section-1">1. Is a Foreign One-Person Corporation Legally Possible?</span>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ Caution:</strong> Many people remit capital after only hearing "a foreign one-person corporation is possible," and then get caught for failing to file foreign exchange notifications. The reporting route (foreign investment notification vs. capital transaction notification) must be locked in before the wire is sent.
</div>

## <span id="section-2">2. One-Person Stock Company vs. Limited Company — Which Fits?</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      ...
      <th style="border:1px solid #e5e7eb;padding:10px">One-Person Stock Company</th>
      <th style="border:1px solid #e5e7eb;padding:10px">One-Person Limited Company</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Investor designation</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Shareholder</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Member</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Minimum directors</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1 (capital under KRW 1 billion)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Statutory auditor</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Waivable if capital under KRW 1 billion</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Not required</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Share transfers</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Free (articles may restrict)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Member consent required (more closed)</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Foreign investment registration</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Available (share-based)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Available (equity-based)</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">D-8 visa linkage</td>
      <td style="border:1px solid #e5e7eb;padding:10px">By far the most common in practice</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Possible, but few precedents</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Attracting outside investors</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Favorable</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Unfavorable</td>
    </tr>
  </tbody>
</table>
...
## <span id="section-3">3. Capital Requirements — KRW 100 Million vs. Below</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      <th style="border:1px solid #e5e7eb;padding:10px">Type</th>
      <th style="border:1px solid #e5e7eb;padding:10px">Minimum Capital</th>
      <th style="border:1px solid #e5e7eb;padding:10px">Basis</th>
      <th style="border:1px solid #e5e7eb;padding:10px">Result</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">D-8-linked one-person corporation</td>
      <td style="border:1px solid #e5e7eb;padding:10px">KRW 100 million or more</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Foreign Investment Promotion Act Enforcement Decree</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Foreign-invested company registration + D-8 application possible</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">General one-person corporation (no visa)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Typically KRW 1–10 million in practice</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Commercial Act (no minimum)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Incorporation possible but does not qualify for D-8</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">Korean subsidiary of foreign parent</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Flexible (KRW 100 million if registering as foreign-invested)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Commercial Act + Foreign Investment Promotion Act</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Decided based on objective</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ Caution:</strong> When sending the KRW 100 million in installments, if the deposit purpose isn't explicitly marked as "foreign direct investment," the foreign-invested company registration will be refused. Submit a copy of the foreign investment notification to the handling bank before wiring, and make sure the correct code is specified for the foreign currency remittance.
</div>

## <span id="section-4">4. Can You Set Up a One-Person Corporation Without a Visa?</span>
...
1. **Corporate seal registration and the registration filing** must take place inside Korea. If the principal can't come, a power of attorney is required.
2. **Opening the corporate bank account** is something nearly every commercial bank in Korea requires the foreign representative director to handle in person, on Korean soil. It cannot be done by email or mail.
...
## <span id="section-5">5. Step-by-Step Incorporation Flow</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      ...
      <th style="border:1px solid #e5e7eb;padding:10px">Time</th>
      <th style="border:1px solid #e5e7eb;padding:10px">Authority</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">1</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Trade name search and drafting articles of incorporation</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">Foreign investment notification (if applicable)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1–3 days</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Authorized bank / KOTRA</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">3</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Capital remittance</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1–2 days</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Home country → Korean bank</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">4</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Issuance of capital deposit certificate</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Same day</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Korean bank</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">5</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Promoter meeting, board meeting, acceptance of office</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1 day</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Per the articles of incorporation</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">Corporate seal registration, registry extract issuance</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Same day</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Local registry office</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">Foreign-invested company registration (if applicable)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">3–7 days</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Authorized bank</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">10</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Corporate bank account opening</td>
      <td style="border:1px solid #e5e7eb;padding:10px">At least one in-person visit</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Korean bank</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">11</td>
      <td style="border:1px solid #e5e7eb;padding:10px">D-8 visa application (if applicable)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">2–4 weeks</td>
      <td style="border:1px solid #e5e7eb;padding:10px">Immigration / Korean consulate abroad</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#dbeafe;border-left:4px solid #2563eb;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#1e40af">💡 Practice Tip:</strong> One-person corporations often sign the office lease in the **promoter's personal name before incorporation**. Inserting a clause for "transfer of name to the corporation post-incorporation" into the lease agreement avoids having to redraft the contract at the business registration stage.
</div>
...
## <span id="section-6">6. Required Documents and Home-Country Preparations</span>
...
<div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;border-radius:8px;margin:20px 0">
  <strong style="color:#166534">✅ Home-Country Preparation Checklist</strong>
  <ul style="margin-top:12px">
    <li>Passport copy (bio page)</li>
    <li>Residence or address certificate (in English)</li>
    <li>Notarized signature certificate</li>
    <li>Apostille or consular authentication (apostille for Hague Convention countries; consular authentication otherwise)</li>
    <li>Home-country ID or driver's license copy (for bank KYC)</li>
    <li>Overseas occupation/income evidence (to explain the source of capital)</li>
    <li>Home-country bank statements covering 6–12 months (to explain fund flow)</li>
    <li>Power of attorney for an in-Korea representative (if the principal is not visiting)</li>
  </ul>
</div>
...
## <span id="section-7">7. Real-World Issues for the Sole Representative</span>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ Caution:</strong> A D-8-linked one-person corporation must file change notifications with Immigration when there is a capital reduction, partial sale of the principal's equity, or closure/suspension of the head office. Skipping this filing causes problems at the next renewal review.
</div>

## <span id="section-8">8. Common Mistakes</span>
...
## <span id="section-10">10. Consultation</span>
