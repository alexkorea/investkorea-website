...
<nav style="background:#f0f7ff;padding:20px;border-radius:8px;margin:24px 0">
  ...
  <ul style="list-style:none;padding-left:0">
    ...
    <li><a href="#section-3" style="color:#2563eb;text-decoration:none">3. 設立手続き5ステップ詳細</a></li>
    <li><a href="#section-4" style="color:#2563eb;text-decoration:none">4. 資本金の基準と送金実務</a></li>
    <li><a href="#section-5" style="color:#2563eb;text-decoration:none">5. 必要書類まとめ</a></li>
    <li><a href="#section-6" style="color:#2563eb;text-decoration:none">6. 設立費用の詳細内訳</a></li>
    <li><a href="#section-7" style="color:#2563eb;text-decoration:none">7. 設立後に必ず押さえるべき行政手続き</a></li>
    <li><a href="#section-8" style="color:#2563eb;text-decoration:none">8. よくある失敗と審査で引っかかるポイント</a></li>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      ...
      <th style="border:1px solid #e5e7eb;padding:10px">株式会社</th>
      <th style="border:1px solid #e5e7eb;padding:10px">有限会社</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">出資単位</td>
      <td style="border:1px solid #e5e7eb;padding:10px">株式(1株あたり100ウォン以上)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">出資口数(1口あたり100ウォン以上)</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">取締役の人数</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1名以上(資本金10億ウォン未満の場合)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1名以上</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外部監査</td>
      <td style="border:1px solid #e5e7eb;padding:10px">一定規模以上で必須</td>
      <td style="border:1px solid #e5e7eb;padding:10px">2018年から一部対象に含まれる</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">持分譲渡</td>
      <td style="border:1px solid #e5e7eb;padding:10px">原則自由</td>
      <td style="border:1px solid #e5e7eb;padding:10px">社員総会の承認が必要</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">D-8との連携</td>
      <td style="border:1px solid #e5e7eb;padding:10px">最も標準的</td>
      <td style="border:1px solid #e5e7eb;padding:10px">可能だが審査で追加説明を求められる</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ 注意:</strong> 標準産業分類表の業種コードを誤って設定すると、FDI申告が差し戻されます。特に「卸小売業」と広く括ってしまうと、実際に取り扱う品目次第で許認可業種と衝突します。業種コードは統計庁のKSICコードで確認し、疑わしい場合は事前に外国為替銀行の窓口で確認しましょう。
</div>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      ...
      <th style="border:1px solid #e5e7eb;padding:10px">手続き</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">資本金送金(投資資金)</td>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      ...
      <th style="border:1px solid #e5e7eb;padding:10px">可否</th>
      <th style="border:1px solid #e5e7eb;padding:10px">実務での位置づけ</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">100ウォン~9,999万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">法人設立のみ可能</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国人投資企業 ❌ / D-8 ❌</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">1億ウォン以上</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国人投資企業の登録が可能</td>
      <td style="border:1px solid #e5e7eb;padding:10px">D-8ビザ申請基準を満たす</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">3億ウォン以上</td>
      <td style="border:1px solid #e5e7eb;padding:10px">同上</td>
      <td style="border:1px solid #e5e7eb;padding:10px">D-8で複数人材の採用やF-2/F-5への連動に有利</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">10億ウォン以上</td>
      <td style="border:1px solid #e5e7eb;padding:10px">同上</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外部監査対象の該当性を再確認</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;border-radius:8px;margin:20px 0">
  <strong style="color:#166534">✅ 個人投資家の必須書類</strong>
  <ul style="margin-top:12px">
    <li>旅券の写し(有効期間6か月以上)</li>
    <li>本国の住所証明書または居住確認書(英文・アポスティーユ付き)</li>
    <li>署名認証書(韓国公館または現地公証)</li>
    <li>投資資金送金の領収書原本</li>
    <li>外国人投資申告書</li>
  </ul>
</div>
...
<div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;border-radius:8px;margin:20px 0">
  <strong style="color:#166534">✅ 法人投資家の必須書類</strong>
  <ul style="margin-top:12px">
    <li>本社の法人登録証明書(アポスティーユまたは韓国公館の領事確認)</li>
    <li>取締役会の投資決議書</li>
    <li>代表者の旅券写しおよび署名認証</li>
    <li>投資資金送金の領収書原本</li>
    <li>外国人投資申告書(法人名義)</li>
  </ul>
</div>
...
<div style="background:#dbeafe;border-left:4px solid #2563eb;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#1e40af">💡 実務のヒント:</strong> アポスティーユは海外の現地でしか取得できず、韓国での発給は不可能です。出国前に本国の公証事務所または外務省で先に取っておくのが近道です。韓国入国後に本国へ戻ってアポスティーユを取り直すケースが実務では意外と多く発生しています。
</div>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  ...
  <tbody>
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">資本金の0.4%</td>
      <td style="border:1px solid #e5e7eb;padding:10px">首都圏過密抑制圏域は3倍重課(1.2%)</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">地方教育税</td>
      <td style="border:1px solid #e5e7eb;padding:10px">登録免許税の20%</td>
      <td style="border:1px solid #e5e7eb;padding:10px">自動賦課</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">定款公証料</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約15~30万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">資本金区分ごとに差あり</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">登記手数料・印紙</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約3~5万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">-</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">法人印鑑作成</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約3~8万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">代表者印鑑もあわせて作成</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#f0f7ff;padding:24px;border-radius:8px;margin:24px 0;border:1px solid #dbeafe">
  ...
  <p style="margin-bottom:0;color:#374151">法人設立 → FDI登録 → D-8ビザ → F-2・F-5永住権への連動まで、一連の流れで設計・代行いたします。まずはお電話でご状況をお聞かせいただければ、資本金規模・業種・滞在計画に合わせた設計案をご提示いたします。</p>
</div>
