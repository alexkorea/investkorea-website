...
실무에서 막히는 지점은 절차 자체보다 **"자본금 출처·송금 경로 증빙"** 과 **"본국 발급 서류의 아포스티유·영사확인"** 입니다.
...
| 외국인투자신고 | 필수 (은행 또는 [KOTRA](https://www.kotra.or.kr)) | 대상 아님 |
| D-8 비자 연계 | 가능 | 불가 |
...
**외부 투자나 공동창업이 계획돼 있으면 주식회사, 1인 또는 100% 모회사 지배 구조면 유한회사**가 관리가 편합니다.
...
이 중 하나라도 비워두면 은행·[등기소](https://www.iros.go.kr)·세무서 중 어딘가에서 반드시 걸립니다.

### 2-1. 자본금 규모

외투법인으로 갈 거라면 **1인 주주 기준 최소 1억 원**을 외국에서 송금해야 합니다.
...
외국인 대표이사는 **체류자격이 없으면 취임은 되지만 실제 업무 수행이 제한**되므로, 비자 일정과 맞물려 있습니다.
...
|---|---|---|---|
| 1 | 외국인투자신고 | 외국환은행 / [KOTRA](https://www.kotra.or.kr) | 당일~2일 |
| 2 | 자본금 송금·증빙 수령 | 해외 송금은행 / 국내 수취은행 | 3~7일 |
| 3 | 정관 작성·공증·등기 신청 | 공증사무소 / 관할 [등기소](https://www.iros.go.kr) | 1~2주 |
| 4 | 사업자등록 | 관할 세무서 | 3~5일 |
| 5 | 외국인투자기업 등록 | 외국환은행 / [KOTRA](https://www.kotra.or.kr) | 1~3일 |

### 3-1. 외국인투자신고 (1단계)

외국환은행 창구 또는 [KOTRA](https://www.kotra.or.kr)에서 신고합니다.
...
이 서류 묶음을 공증 받은 뒤 본점 소재지 관할 [등기소](https://www.iros.go.kr)에 **설립등기**를 신청합니다.
...
법인 설립등기부·외화매입증명서·외국인투자신고서 수리본을 모아 외국환은행이나 [KOTRA](https://www.kotra.or.kr)에 제출하면 **외국인투자기업 등록증**이 발급됩니다.
...
**번역공증은 국내 공증사무소에서 받는 번역공증**과 **본국 공증인이 영문으로 공증한 뒤 한국어 번역을 붙이는 방식**두 가지가 있는데, [등기소](https://www.iros.go.kr)·은행마다 선호가 갈립니다.
...
외투법인을 세우는 실제 이유의 절반 이상이 **D-8 기업투자 비자**입니다.
...
이미 한국에 D-10(구직)·C-3(단기방문) 등으로 들어와 있다면, 설립이 끝난 뒤 [출입국·외국인청](https://www.immigration.go.kr)에 **체류자격 변경허가**를 신청합니다.

C-3 단기방문 상태에서 직접 D-8로의 변경은 원칙적으로 제한되지만, 외국인투자기업 등록이 완료된 경우 예외 처리되는 케이스가 있습니다.

관할 출입국 확인이 먼저입니다.

**💡 실무 팁:** D-8 심사에서는 자본금 1억 원 "입금 자체"보다 **사업계획의 일관성**을 더 봅니다.
...
가장 비용이 큰 실수는 **"신고 전 송금"** 과 **"과밀억제권역 중과 누락"** 두 가지입니다.
...
다만 은행 계좌 개설 단계에서 대표이사 본인 대면을 요구하는 지점이 늘고 있어, **최소 1회 방한이 현실적**입니다.
...
대표이사 개인 용도로 인출하면 **가지급금**으로 처리돼 법인세·소득세·인정이자까지 붙습니다.
...
실제 심사 기간보다 **사업계획·사무실·자금 설명의 일관성**이 통과 여부를 더 크게 가릅니다.
## 전문가 상담이 필요하신가요?
