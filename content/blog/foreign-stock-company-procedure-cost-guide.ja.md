...
<nav style="background:#f0f7ff;padding:20px;border-radius:8px;margin:24px 0">
  ...
  <ul style="list-style:none;padding-left:0">
    ...
    <li><a href="#section-3" style="color:#2563eb;text-decoration:none">3. 設立手続きのステップ別・実務の流れ</a></li>
    <li><a href="#section-4" style="color:#2563eb;text-decoration:none">4. 必要書類の詳細リストと公証・アポスティーユ</a></li>
    <li><a href="#section-5" style="color:#2563eb;text-decoration:none">5. 設立費用の総まとめ - 政府費用と代行費用</a></li>
    <li><a href="#section-6" style="color:#2563eb;text-decoration:none">6. 設立後に必ず行うべき後続手続き</a></li>
    <li><a href="#section-7" style="color:#2563eb;text-decoration:none">7. D-8ビザと株式会社設立のつながり</a></li>
    <li><a href="#section-8" style="color:#2563eb;text-decoration:none">8. よくある失敗と審査でつまずくポイント</a></li>
    <li><a href="#faq" style="color:#2563eb;text-decoration:none">9. よくある質問(FAQ)</a></li>
    <li><a href="#cta" style="color:#2563eb;text-decoration:none">10. ビジョン行政士事務所の相談案内</a></li>
  </ul>
</nav>

## <span id="section-1">1. 外国人の株式会社、どの形態で設立するかを先に決める</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  ...
  <tbody>
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">制限なし(FDIは1億)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">制限なし(FDIは1億)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">制限なし</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外部監査の対象</td>
      <td style="border:1px solid #e5e7eb;padding:10px">一定規模以上は義務</td>
      <td style="border:1px solid #e5e7eb;padding:10px">一定規模以上は義務</td>
      <td style="border:1px solid #e5e7eb;padding:10px">該当なし</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">投資誘致</td>
      <td style="border:1px solid #e5e7eb;padding:10px">株式発行で自由</td>
      <td style="border:1px solid #e5e7eb;padding:10px">持分譲渡が限定的</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">可能</td>
      <td style="border:1px solid #e5e7eb;padding:10px">可能(要件審査あり)</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">開示負担</td>
      <td style="border:1px solid #e5e7eb;padding:10px">相対的に大きい</td>
      <td style="border:1px solid #e5e7eb;padding:10px">小さい</td>
      <td style="border:1px solid #e5e7eb;padding:10px">最も小さい</td>
    </tr>
  </tbody>
</table>
...
## <span id="section-2">2. 資本金の基準と外国人投資企業の登録条件</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      <th style="border:1px solid #e5e7eb;padding:10px">業種タイプ</th>
      <th style="border:1px solid #e5e7eb;padding:10px">法定最低額</th>
      <th style="border:1px solid #e5e7eb;padding:10px">実務推奨の資本金</th>
      <th style="border:1px solid #e5e7eb;padding:10px">備考</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">コンサル・貿易業</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1億〜1.5億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">賃料・事業性の説明が必須</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">IT・ソフトウェア</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1.5億〜3億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">人件費規模の説明</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">製造業</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">3億〜5億ウォン以上</td>
      <td style="border:1px solid #e5e7eb;padding:10px">工場・設備費は別枠</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">流通・卸小売</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">2億〜3億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">在庫・物流費の説明</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">飲食・サービス業</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">2億〜3億ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">許認可業種に注意</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ 注意:</strong> 資本金は「銀行に入金された」で終わりではなく、「外国人投資目的の送金として識別される」ことが必要です。本人名義の海外口座から → 本人名義の韓国内バーチャル口座(投資金保管用)に入金される必要があり、第三者送金や現金を持参しての入国は審査で引っかかる可能性があります。
</div>

## <span id="section-3">3. 設立手続きのステップ別・実務の流れ</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">投資金の送金・保管口座への入金</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">資本金払込保管証明書の発行</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国為替銀行</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1日</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">4</td>
      <td style="border:1px solid #e5e7eb;padding:10px">定款作成・公証</td>
      <td style="border:1px solid #e5e7eb;padding:10px">公証事務所</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1〜2日</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">5</td>
      <td style="border:1px solid #e5e7eb;padding:10px">設立登記申請</td>
    ...
    <tr>
      ...
      <td style="border:1px solid #e5e7eb;padding:10px">法人口座開設・実名確認</td>
...
<div style="background:#dbeafe;border-left:4px solid #2563eb;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#1e40af">💡 実務ヒント:</strong> 外国人の代表者が韓国に入国する前でも、「委任状 + 本国の公証・アポスティーユ」で先に設立登記を進めることができます。代表者が入国せずに設立を終わらせ、法人登記が済んだ状態でD-8ビザを取得して入国するという流れが、実務的に最もスピーディです。
</div>

## <span id="section-4">4. 必要書類の詳細リストと公証・アポスティーユ</span>
...
<div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;border-radius:8px;margin:20px 0">
  <strong style="color:#166534">✅ 外国人個人投資家の必須書類チェックリスト</strong>
  <ul style="margin-top:12px">
    <li>パスポートのコピー(全ページ、カラースキャン)</li>
    <li>本国の住所証明書(Certificate of Residence/Address Proof) - 公証 + アポスティーユ</li>
    <li>本国の身元証明または署名認証書 - 公証 + アポスティーユ</li>
    <li>外国人投資申告書(所定様式)</li>
    <li>投資家の資金出所の証憑(預金残高証明、在職証明、事業所得資料など)</li>
    <li>委任状(代理人による設立の場合) - 公証 + アポスティーユ</li>
    <li>パスポート・書類の韓国語翻訳文 + 翻訳公証</li>
    <li>本国からの送金明細または送金予定口座の確認書</li>
  </ul>
</div>
...
<div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;border-radius:8px;margin:20px 0">
  <strong style="color:#166534">✅ 外国法人株主の必須書類チェックリスト</strong>
  <ul style="margin-top:12px">
    <li>本国の法人登記簿謄本(Certificate of Incorporation) - 公証 + アポスティーユ</li>
    <li>定款(Articles of Association) - 公証 + アポスティーユ</li>
    <li>取締役会決議書(韓国法人への投資決定) - 公証 + アポスティーユ</li>
    <li>代表者の署名認証書(Signature Certificate) - 公証 + アポスティーユ</li>
    <li>委任状(韓国側代理人の指定) - 公証 + アポスティーユ</li>
    <li>本国法人の直近決算書(審査時に要求される場合あり)</li>
    <li>上記すべての書類の韓国語翻訳文 + 翻訳公証</li>
  </ul>
</div>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      <th style="border:1px solid #e5e7eb;padding:10px">国</th>
      <th style="border:1px solid #e5e7eb;padding:10px">認証方式</th>
      <th style="border:1px solid #e5e7eb;padding:10px">想定期間</th>
      <th style="border:1px solid #e5e7eb;padding:10px">注意点</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">米国・英国・日本・EU主要国</td>
      <td style="border:1px solid #e5e7eb;padding:10px">アポスティーユ</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1〜2週間</td>
      <td style="border:1px solid #e5e7eb;padding:10px">州ごとに発行機関が異なる</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">中国</td>
      <td style="border:1px solid #e5e7eb;padding:10px">領事認証</td>
      <td style="border:1px solid #e5e7eb;padding:10px">2〜4週間</td>
      <td style="border:1px solid #e5e7eb;padding:10px">公証 → 外交部 → 韓国領事館の3段階</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">ベトナム</td>
      <td style="border:1px solid #e5e7eb;padding:10px">領事認証</td>
      <td style="border:1px solid #e5e7eb;padding:10px">2〜3週間</td>
      <td style="border:1px solid #e5e7eb;padding:10px">地方の公証事務所ごとに手続きが異なる</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">カザフスタン・ウズベキスタン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">アポスティーユ</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1〜2週間</td>
      <td style="border:1px solid #e5e7eb;padding:10px">ロシア語の翻訳公証も追加で必要</td>
    </tr>
  </tbody>
</table>
...
## <span id="section-5">5. 設立費用の総まとめ - 政府費用と代行費用</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      ...
      <th style="border:1px solid #e5e7eb;padding:10px">資本金1億</th>
      <th style="border:1px solid #e5e7eb;padding:10px">資本金3億</th>
      <th style="border:1px solid #e5e7eb;padding:10px">備考</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">登録免許税(ソウル)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1,200,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">3,600,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">過密抑制で3倍重課</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">登録免許税(地方)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">400,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">1,200,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">0.4%の基本税率</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">地方教育税</td>
      <td style="border:1px solid #e5e7eb;padding:10px">登録免許税の20%</td>
      <td style="border:1px solid #e5e7eb;padding:10px">登録免許税の20%</td>
      <td style="border:1px solid #e5e7eb;padding:10px">追加で賦課</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">定款公証(10億未満は省略可)</td>
      <td style="border:1px solid #e5e7eb;padding:10px">0〜300,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">0〜300,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">規模・公証事務所により差</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">登記申請手数料・証紙</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約50,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約50,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">収入証紙</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">翻訳・翻訳公証</td>
      <td style="border:1px solid #e5e7eb;padding:10px">200,000〜500,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">200,000〜500,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">書類分量による</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">本国の公証・アポスティーユ</td>
      <td style="border:1px solid #e5e7eb;padding:10px">100,000〜400,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">100,000〜400,000ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">国ごとに差異あり</td>
    </tr>
  </tbody>
</table>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      <th style="border:1px solid #e5e7eb;padding:10px">ケース</th>
      <th style="border:1px solid #e5e7eb;padding:10px">政府実費</th>
      <th style="border:1px solid #e5e7eb;padding:10px">代行手数料</th>
      <th style="border:1px solid #e5e7eb;padding:10px">合計(概算)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外国人個人1人 / 資本金1億 / ソウル</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約160万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">150万〜200万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">310万〜360万ウォン</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外国法人株主 / 資本金1億 / ソウル</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約180万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">250万〜400万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">430万〜580万ウォン</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外国人2人の合弁 / 資本金3億 / ソウル</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約430万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">200万〜350万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">630万〜780万ウォン</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外国人個人 / 資本金1億 / 地方</td>
      <td style="border:1px solid #e5e7eb;padding:10px">約60万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">150万〜200万ウォン</td>
      <td style="border:1px solid #e5e7eb;padding:10px">210万〜260万ウォン</td>
    </tr>
  </tbody>
</table>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ 注意:</strong> D-8ビザの審査では「資本金が実際に事業に使われているか」が見られます。資本金を設立直後に代表者個人の口座に移したり、何の支出もせずそのまま預けておくだけだと、事業の実体が弱く見えます。設立直後から賃料・給与・設備購入など合理的な支出の流れを作っておかないと、更新審査で引っかかります。
</div>
...
## <span id="section-6">6. 設立後に必ず行うべき後続手続き</span>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  <thead style="background:#f0f7ff">
    <tr>
      <th style="border:1px solid #e5e7eb;padding:10px">変更事由</th>
      <th style="border:1px solid #e5e7eb;padding:10px">申告期限</th>
      <th style="border:1px solid #e5e7eb;padding:10px">申告機関</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">増資・減資</td>
      <td style="border:1px solid #e5e7eb;padding:10px">変更後、遅滞なく</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国為替銀行/KOTRA</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">外国人株主の持分変動</td>
      <td style="border:1px solid #e5e7eb;padding:10px">変更後、遅滞なく</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国為替銀行/KOTRA</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">代表者・商号・本店の変更</td>
      <td style="border:1px solid #e5e7eb;padding:10px">登記変更後、遅滞なく</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国為替銀行/KOTRA</td>
    </tr>
    <tr>
      <td style="border:1px solid #e5e7eb;padding:10px">業種追加</td>
      <td style="border:1px solid #e5e7eb;padding:10px">変更後、遅滞なく</td>
      <td style="border:1px solid #e5e7eb;padding:10px">外国為替銀行/KOTRA</td>
    </tr>
  </tbody>
...
## <span id="section-7">7. D-8ビザと株式会社設立のつながり</span>
...
<div style="background:#dbeafe;border-left:4px solid #2563eb;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#1e40af">💡 実務ヒント:</strong> 事業計画書は分量ではなく数字です。「2年以内に従業員5人を雇用、売上5億ウォンを目指す」と書くのであれば、その数字が賃料・人件費・売上の前提とかみ合っていなければなりません。計算が合わない計画書は、どれだけ長く書いても実際の審査で引っかかります。
</div>

## <span id="section-8">8. よくある失敗と審査でつまずくポイント</span>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ 注意:</strong> 市中銀行の法人口座開設は、マネーロンダリング防止(AML)の基準が強化され、外国人代表1人の法人に対する開設審査が厳しくなっています。1つの銀行で断られても諦めず、**メインバンク + 外国人法人への対応実績のある支店** を事前に確認してアプローチするのが得策です。
</div>

## <span id="faq">9. よくある質問(FAQ)</span>
...
## <span id="cta">10. ビジョン行政士事務所の相談案内</span>
...
<div style="background:#f0f7ff;padding:24px;border-radius:8px;margin:24px 0;border:1px solid #bfdbfe">
  ...
  <p style="margin-top:16px;color:#374151">外国人株式会社の設立、外国人投資申告、D-8ビザ、増資・持分変更の申告まで、ステップごとにサポートいたします。本国書類の公証・アポスティーユの段階からご相談可能です。</p>
</div>

法令・手数料・過密抑制圏域の基準は改正される可能性があるため、最終確定前には **管轄機関またはビジョン行政士事務所への確認が必要** です。
