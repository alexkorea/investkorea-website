...
<li><a href="#id3" style="color:#2563eb;text-decoration:none">3. 関連税金案内</a></li>
<li><a href="#id4" style="color:#2563eb;text-decoration:none">4. 必要書類一覧</a></li>
<li><a href="#id5" style="color:#2563eb;text-decoration:none">5. 一般的なミスと注意事項</a></li>
...
<li>取得税、財産税などの税金が課され、税率は不動産の種類によって異なります。</li>
</ul>
</div>
...
<th style="padding:12px;text-align:left;border:1px solid #e5e7eb">段階</th>
<th style="padding:12px;text-align:left;border:1px solid #e5e7eb">説明</th>
</tr>
<tr>
<td style="padding:12px;border:1px solid #e5e7eb">身元確認</td>
<td style="padding:12px;border:1px solid #e5e7eb">必要書類準備</td>
</tr>
<tr>
<td style="padding:12px;border:1px solid #e5e7eb">契約締結</td>
<td style="padding:12px;border:1px solid #e5e7eb">売主と契約</td>
</tr>
<tr>
<td style="padding:12px;border:1px solid #e5e7eb">登録</td>
<td style="padding:12px;border:1px solid #e5e7eb">不動産登記所に登録</td>
</tr>
</table>
