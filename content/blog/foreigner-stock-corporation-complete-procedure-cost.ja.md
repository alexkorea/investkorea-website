...
<nav style="background:#f0f7ff;padding:20px;border-radius:8px;margin:24px 0">
  ...
  <ul style="list-style:none;padding-left:0">
    ...
    <li><a href="#section-3" style="color:#2563eb;text-decoration:none">3. 外国人投資申告の流れと審査実態</a></li>
    <li><a href="#section-4" style="color:#2563eb;text-decoration:none">4. 設立費用・期間・書類一覧表</a></li>
    <li><a href="#section-5" style="color:#2563eb;text-decoration:none">5. 書類準備チェックリスト</a></li>
    <li><a href="#section-6" style="color:#2563eb;text-decoration:none">6. 実務でつまずくポイントと注意点</a></li>
    <li><a href="#section-7" style="color:#2563eb;text-decoration:none">7. よくある失敗まとめ</a></li>
...
<table style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb">
  ...
  <tbody>
    ...
    <tr>
      <td>主な機関</td>
      <td>裁判所、税務署</td>
      <td>裁判所、KOTRA、銀行、税務署、外国人投資担当機関</td>
    </tr>
    <tr>
      <td>処理期間</td>
      <td>3～7日</td>
...
<div style="background:#fef3c7;border-left:4px solid #f59e0b;padding:16px;margin:20px 0;border-radius:4px">
  <strong style="color:#92400e">⚠️ 注意:</strong> 送金や設立代行費用は金額、法人形態、代行の難易度によって大きく異なります。失敗例のほとんどは<strong>資金入金時の証明不足</strong>や<strong>ビザ要件（経歴・資格）で審査不合格</strong>が多いです。
</div>
...
<div style="background:#f0fdf4;border:1px solid #86efac;padding:20px;border-radius:8px;margin:20px 0">
  ...
  <ul style="margin-top:12px">
    <li>投資者パスポート（原本とコピー）</li>
    <li>外国人投資申告書（KOTRA等各機関フォーマット）</li>
    <li>送金明細・取引内容証明</li>
    <li>法人設立書類（定款、設立総会議事録、代表取締役選任書など）</li>
    <li>株式取得書類（株主名簿、取得契約書）</li>
    <li>オフィス賃貸契約書</li>
    <li>代表者・役員の経歴や資格証明コピー（ビザ申請時）</li>
    <li>外国人登録証（既に滞在中の場合）</li>
    <li>事業計画書（ビザ申請時）</li>
    <li>各種登録・申告書類（裁判所、税務署、出入国など）</li>
  </ul>
</div>
