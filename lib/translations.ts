...
export const translations = {
  ko: {
      ...
      slides: [
        {
          ...
          subtitle: "외국인 투자법인 설립부터 사업자 등록까지 원스톱 지원",
          cta: "회사설립 알아보기",
        },
        {
          title: "D-8 · D-7 비자 전문 처리",
          subtitle: "D-8 기업투자비자 · D-7 주재원비자 전문 컨설팅",
          cta: "비자 상담 신청",
        },
        {
          title: "F-5 영주권 · 투자이민",
          subtitle: "고액투자 · 부동산 · 공익사업 영주권 맞춤 전략",
          cta: "영주권 전략 보기",
        },
        {
          title: "8년 이상의 전문 행정사 경험",
          subtitle: "연간 200건+ 성공 사례 · 다국어 지원 · 8년 경력",
          cta: "무료 상담 예약",
        },
      ],
    },
    ...
    footer: {
      ...
      address: "(04614) 서울특별시 중구 퇴계로 324, 3층 (성우빌딩) | 동대문역사문화공원역 4번출구 10미터",
    },
  },
  en: {
    nav: {
