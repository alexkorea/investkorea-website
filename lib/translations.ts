...
export const translations = {
  ...
  en: {
    nav: {
      ...
      f5Investment: "F-5 Permanent Residency High-Value Investment",
      f5Visa: "F-5 Permanent Residency & Investment Visa",
      f5Strategies: "Permanent Residency Strategy",
      realEstate: "F-2 Visa Real Estate Investment Immigration",
      publicInterest: "F-2 Visa Public Interest Immigration",
      about: "About Us",
      blog: "Blog",
      contact: "Contact",
    ...
    services: {
      ...
      items: [
        ...
        {
          title: "F-2 Visa Public Interest Immigration",
    ...
    team: {
      ...
      specialists: [
        ...
        },
        {
          ...
          specialties: ["D-8 Visa", "F-5 Permanent Residency High-Value Investment"],
        },
        {
          name: "Han Kyung-taek",
          role: "Administrative Specialist",
        ...
        },
        {
          ...
          role: "Administrative Specialist",
          languages: ["Korean", "English"],
          specialties: ["F-2 Visa Real Estate Investment Immigration", "Investment Strategy"],
        },
        {
          name: "Jung Hee-jung",
          role: "Administrative Specialist",
    ...
    team: {
      ...
      specialists: [
        ...
        },
        {
          ...
          role: "行政士",
          languages: ["韓国語", "英語"],
          specialties: ["F-2ビザ 不動産投資移民", "投資戦略"],
        },
        {
          name: "鄭熙晶",
          role: "行政士",
