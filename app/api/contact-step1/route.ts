...
function buildEmailHtml(name: string, services: string[], inquiryId: string): string {
  ...
  const step2Url = `https://www.investkorea.co.kr/contact/step2?service=${serviceParam}&inquiryId=${inquiryId}`
...
<body style="margin:0;padding:0;background-color:#f4f6f9;font-family:'Apple SD Gothic Neo','Malgun Gothic',sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f6f9;padding:40px 20px;">
    <tr><td align="center">
      ...
      <p style="margin:24px 0 0;color:#bbb;font-size:11px;text-align:center;">본 메일은 investkorea.co.kr 상담 신청에 의해 자동 발송되었습니다.</p>
    </td></tr>
  </table>
</body>
</html>`
