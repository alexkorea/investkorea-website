...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata("companyBranch" as PageKey, locale)
}
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageBreadcrumb items={[
        ...
        { label: t.title, path: "/company/branch" },
      ]} locale={locale} />
      <ServiceJsonLd name={t.title} description={t.subtitle} locale={locale} path="/company/branch" />
