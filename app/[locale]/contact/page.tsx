...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata("contact" as PageKey, locale)
}
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageBreadcrumb items={[
        { label: t.title, path: "/contact" },
      ]} locale={locale} />
      <ServiceJsonLd name={t.title} description={t.subtitle} locale={locale} path="/contact" />
