...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata("visaD8Process" as PageKey, locale)
}
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageBreadcrumb items={[
        ...
        { label: t.title, path: "/visa/d8-process" },
      ]} locale={locale} />
      <ServiceJsonLd name={t.title} description={t.subtitle} locale={locale} path="/visa/d8-process" />
