...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata("visaF5Strategies" as PageKey, locale)
}
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageBreadcrumb items={[
        ...
        { label: t.title, path: "/visa/f5-strategies" },
      ]} locale={locale} />
      <ServiceJsonLd name={t.title} description={t.subtitle} locale={locale} path="/visa/f5-strategies" />
