...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return getPageMetadata("visaD7Details" as PageKey, locale)
}
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageBreadcrumb items={[
        ...
        { label: t.title, path: "/visa/d7-details" },
      ]} locale={locale} />
      <ServiceJsonLd name={t.title} description={t.subtitle} locale={locale} path="/visa/d7-details" />
