...
const serviceFields: Record<string, FieldDef[]> = {
  ...
  "F-5 영주권": [
    { name: "currentVisa", label: "현재 비자 종류", type: "select", options: ["D-8 (투자)", "D-7 (주재원)", "E-7 (취업)", "F-2 (거주)", "기타"], required: true },
    { name: "stayDuration", label: "한국 체류 기간", type: "select", options: ["1년 미만", "1~3년", "3~5년", "5년 이상"], required: true },
    { name: "investAmount", label: "현재 투자 금액", type: "select", options: ["1억 원", "3억 원", "5억 원 이상", "해당 없음"], required: true },
    { name: "employees", label: "한국인 고용 인원", type: "select", options: ["없음", "1~2명", "3~5명", "5명 이상"], required: true },
    { name: "companyType", label: "법인 형태", type: "select", options: ["주식회사", "유한회사", "지사", "연락사무소", "해당 없음"], required: true },
    { name: "income", label: "연간 소득 수준 (급여 기준)", type: "select", options: ["3,000만 원 미만", "3,000만 ~ 5,000만 원", "5,000만 ~ 1억 원", "1억 원 이상"], required: true },
    { name: "criminalRecord", label: "한국 내 범죄/벌금 이력", type: "radio", options: ["없음", "있음"], required: true },
    { name: "topik", label: "한국어 능력", type: "select", options: ["없음", "TOPIK 1~2급", "TOPIK 3~4급", "TOPIK 5~6급", "사회통합프로그램 이수"], required: false },
  ],
  "연락사무소설치": [
    { name: "nationality", label: "본사 소재국", type: "text", placeholder: "예: 미국, 중국, 일본", required: true },
    { name: "companyName", label: "본사 회사명", type: "text", placeholder: "본사 정식 명칭", required: true },
    { name: "purpose", label: "연락사무소 설치 목적", type: "select", options: ["시장조사", "업무연락", "현지 파트너 발굴", "기타"], required: true },
    { name: "setupDate", label: "설치 예정일", type: "text", placeholder: "예: 2026년 6월", required: false },
  ],
  "D-9-2 설비파견": [
    { name: "nationality", label: "국적", type: "text", placeholder: "예: 미국, 중국, 일본", required: true },
    { name: "equipmentType", label: "설비/장비 종류", type: "text", placeholder: "예: 반도체 장비, 생산라인", required: true },
    { name: "projectDuration", label: "파견 예정 기간", type: "select", options: ["3개월 미만", "3~6개월", "6개월~1년", "1년 이상"], required: true },
    { name: "workerCount", label: "파견 인원 수", type: "text", placeholder: "예: 5명", required: true },
    { name: "clientCompany", label: "한국 발주처(수입업체)", type: "text", placeholder: "한국 고객사 명칭", required: false },
  ],
  "기타": [
